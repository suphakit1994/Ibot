		...
		<form method="POST"  action="index.php?app=admin&action=about_us_performance_edit/add" enctype="multipart/form-data">
			...
			<div class="flex-container">
				<div class="flex-col1" style="align-items: center;">
					...
					<textarea name="name" style="width: 1000px; height: 110px;"><?php echo $per_sel['name']; ?></textarea>
					<div style=" padding-bottom: 30px;">
						<div class="flex-upload-pic">
							...
							<div style="display: flex;justify-content: center;width: 100%;">
								<input  class="file-upload" value="../aboutus_img/<?php echo $per_sel['image_per'];?>" type="file" name="image_per" accept="image/*" required >
							</div>
