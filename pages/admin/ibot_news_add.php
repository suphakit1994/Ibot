...
<body>
	<div class="page-content p-5" id="content">
		...
		<form method="POST"  action="index.php?app=admin&action=ibot_news_add/add" enctype="multipart/form-data">

			<div class="flex-container">
				<div class="flex-col1">
					<div style="align-self: center;">
						<p class="list_detail"><b>Topic News</b> </p>
						<input type="text" name="topic" class="form-control" style="width: 1000px; "required>
					</div>
					<div style="align-self: center;">
						<p class="list_detail" style="margin-top:  20px; "><b>Content News</b></p>
						<textarea name="content" style="width: 1000px; height: 400px;"></textarea> 
					</div>
					<div style=" padding-top: 30px; ">
						<div class="flex-upload-pic">
							<div style="align-self: center;">
								<p class="list_detail"><b>Image News</b> </p>
								...
								<div style="display: flex;justify-content: center;width: 100%;">
									<input  class="file-upload"  type="file" name="img_news" accept="image/*" required >
								</div>
