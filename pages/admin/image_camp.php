...
<body>
	...
	<div class="containner">
		<div class="page-content p-5" id="content" style="padding: 2%;">
			...
			<form method="POST"  action="index.php?app=admin&action=image_camp/update" enctype="multipart/form-data">
				
				<div style=" padding-bottom: 30px;">
					<h1 style="text-align: center; font-weight: bold;">Camp</h1>
					<div class="flex-upload-pic">
						...
						<div style="display: flex;justify-content: center;width: 100%;">
							<input  class="file-upload" type="file" name="image_name_camp" accept="image/*" required >
						</div>
