					...
					<div class="row">
						...
						<div class="col-md-9" style="padding-top: 65px;">
							<div class="row">
								<div class="col-sm-3">
									<p><b>First name</b></p>
									<input class="form-control" type="text" value="<?php echo $select_idteacher[$i]['teacher_fname'];?>" name="fname">
								</div>
								<div class="col-sm-3">
									<p><b>Last name</b></p>
									<input class="form-control" type="text" value="<?php echo $select_idteacher[$i]['teacher_lname'];?>" name="lname">
								</div>
								<div class="col-sm-3">
									<p><b>Position</b></p>
									<input class="form-control" type="text" value="IE Thai software" disabled>
								</div>
							</div>
							<div class="row" style="margin-top: 10px;">
								<div class="col-sm-3">
									<p><b>Username</b></p>
									<input class="form-control" type="text" value="<?php echo $select_idteacher[$i]['teacher_username'];?>" name="username">
								</div>
								<div class="col-sm-3">
									<p><b>Password</b></p>
									<input class="form-control" type="text" value="<?php echo $select_idteacher[$i]['teacher_password'];?>" name="password">
								</div>
							</div>
							<div class="row" style="margin-top: 50px;">
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<input class="form-control" type="" value="<?php echo $select_idteacher[$i]['teacher_email'];?>" name="email">
									</div>
									<div class="col-sm-6">
										<label>Telephone:</label></br>
										<input class="form-control" type="" value="<?php echo $select_idteacher[$i]['teacher_phone'];?>" name="phone">
									</div>
								</div>
							</div>
							<div class="row" style="margin-top: 50px;">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<select style="font-size:14pt" class="form-control" name="hour" id="hour">
											<?php $hour = 0;
											for($i=0;$i<10;$i++){ $hour = $hour+1;?>
												<option value="<?php echo $hour; ?>"><?php echo $hour; ?> hour</option>
											<?php }?>
										</select>
									</div>
									<div class="col-md-3">
