					...
					<div class="row" style="display: flex; align-items: center;">
						...
						<div class="col-sm-6">
							<div style="display: flex;justify-content: flex-end">
								<a class="btn btn-primary" style="padding: 4px;" href="index.php?app=admin&action=text_slide_add">+ Add New</a>
							</div>
							<div style="display: flex;justify-content: flex-end">
								...
								<td>
									<div class="dropdown" >
										...
										<ul class="dropdown-menu">
											<li>
												<form method="post" action="index.php?app=admin&action=text_slide_edit">
											...
											<li>
												<form method="post" action="index.php?app=admin&action=text_slide_delete">
													<a><button type="submit" name= "<?php echo $i ?>" class=" btn btn:hover">
