...
<body>
  <div class="container-fruid">
    ...
    <div class="row" style="text-align: center;">
      ...
      <div class="ButtonBack" data-toggle="modal" data-target="#myModalshow" style="padding-left: 2%; padding-right: 2%;">Trial Class</div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px;">
              <p>โปรดติดต่อแอดมินทางเบอร์: 089-7178817 เพื่อติดต่อทดลองเรียน</p>
            </div>
