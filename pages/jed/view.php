            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-5" style="margin-left:2%; margin-top:8%;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5" style="margin-left:1%;">
                                <p style="text-align: left;margin-left: 19%;margin-top: 14%; font-size: 15px;"><b>Out</b></p>
                    </div>
                </div>
                ...
                <div class=" row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <p style="text-align: left; margin-left: 19%;">Part time</p>
                                    <p style="text-align: left; margin-left: 19%;">25 years old</p>
                                    <p style="text-align: left; margin-left: 19%;">Sat 10:30-12:00 ฿ 75/Day</p>
                                    <p style="text-align: left; margin-left: 19%;">Sun 10:30-12:00 ฿ 75/Day</p>
                                </div>
                            </div>
                        </div>
                    </div>
