				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="index.php?app=faii">Our asdasd</a></li>
							<!-- 						<li><a href="index.php?app=jed">jed</a></li> -->
							<li><a href="index.php?app=about">asdasdas Us</a></li>
<!-- 						<li><a href="index.php?app=pdf">pdf</a></li>
	<li><a href="index.php?app=art">art</a></li> -->
	<li><a href="index.php?app=branch">asdas</a></li>
	<li><a href="index.php?app=branch">asdasdasdas us</a></li>
